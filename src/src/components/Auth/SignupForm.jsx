        ...
        <div className="flex flex-col items-center justify-center  text-white bg-white bg-no-repeat bg-cover bg-center">
            <div className="">
                <div className="w-full flex flex-col items-center justify-center">
                    ...
                    >
                        {error && (
                            <div className="w-full p-3 text-sm text-red-700 bg-red-100 rounded-lg border border-red-300 mb-4">
                                {error}
                            </div>
                        )}
                        <button
                            type="button"
                            className="w-full mt-8 bg-gray-500/10 flex items-center justify-center h-12 rounded-full hover:opacity-90 transition-opacity"
                        >
                            <img
